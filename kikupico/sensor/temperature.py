...
class Temperature:
    ...
    def __str__(self):
        return "{:.2f} {:.2f} {:.2f}".format(self.temperature, self.pressure, self.humidity)
...
class CalibrationData:
    ...
    def __print(self):
        ...
        print(self.p1, self.p2, self.p3, self.p4, self.p5, self.p6, self.p7, self.p8, self.p9)
    ...
    def compensate_temperature(self, data):
        ...
        return Temperature(temperature, pressure / 100, humidity, data)
